...
export const servers = mysqlTable('servers', {
    ...
    heroBackgroundUploadId: char('hero_background_upload_id', { length: 36 }),
    heroLogoUploadId: char('hero_logo_upload_id', { length: 36 }),
    heroVideoSource: varchar('hero_video_source', { length: 16 }),
    heroVideoUploadId: char('hero_video_upload_id', { length: 36 }),
    heroVideoUrl: varchar('hero_video_url', { length: 2048 }),
    heroEyebrow: varchar('hero_eyebrow', { length: 128 }),
    heroTitle: varchar('hero_title', { length: 128 }),
    heroTagline: varchar('hero_tagline', { length: 500 }),
    newsRss: varchar('news_rss', { length: 2048 }),
