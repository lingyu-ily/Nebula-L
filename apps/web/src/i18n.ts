...
const zhTW = {
    translation: {
        ...
        versionsLoading: '正在載入版本建議…', versionsUnavailable: '無法取得版本建議，仍可手動輸入。', versionsStale: '目前顯示快取版本，仍可手動輸入。', manualVersionHint: '可從建議清單選擇，或直接輸入版本。', noCompatibleVersions: '找不到相容版本，仍可手動輸入。',
