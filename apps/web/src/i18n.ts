...
const en = {
    translation: {
        ...
        saveServerOrder: 'Save order', savingServerOrder: 'Saving order…', moveServerUp: 'Move {{name}} up', moveServerDown: 'Move {{name}} down', serverPosition: 'Position {{position}}', serverMoved: 'Moved {{name}} to position {{position}}.',
        ...
        previousPage: 'Previous', nextPage: 'Next', pageNumber: 'Page {{page}}', jobsPagination: 'Background job pages', releasesPagination: 'Release pages',
        ...
        launcherPageHint: 'Per-server artwork, branding copy, and update feed published to Helios.', launcherBackground: 'Hero background', launcherLogo: 'Hero logo', launcherEyebrow: 'Launcher header label', launcherTitle: 'Hero title', launcherTagline: 'Hero description', launcherNewsRss: 'Server update RSS URL',
        launcherUsesDefault: 'Uses the Launcher default', launcherImageConfigured: 'Custom image selected', launcherImageMissing: 'The source image is missing. Re-upload it.', launcherClearImage: 'Clear image', launcherEmptyFallback: 'Empty fields inherit the distribution or Launcher default.', launcherImageTypeError: 'Choose a PNG, JPEG, or WebP image.', launcherFallbackEyebrow: 'MAPLECRAFT', launcherFallbackTagline: 'Server content will appear here.', launcherPreviewPlay: 'Play', launcherPreviewMods: 'Mods', launcherPreviewUpdates: 'Patch notes',
        launcherVideo: 'Hero video', launcherVideoNone: 'No video', launcherVideoUpload: 'Upload MP4 / WebM', launcherVideoExternal: 'External MP4 / WebM URL', launcherVideoYouTube: 'YouTube video', launcherVideoExternalUrl: 'Public video URL', launcherVideoYouTubeUrl: 'YouTube URL', launcherVideoExternalHint: 'The HTTPS video is verified and copied into the immutable release when publishing.', launcherVideoYouTubeHint: 'Single watch, short, youtu.be, or embed URLs are supported.', launcherVideoConfigured: 'A video is configured', launcherVideoFileRequired: 'Choose an MP4 or WebM file.', launcherVideoUrlRequired: 'Enter a video URL.', launcherVideoTypeError: 'Choose an MP4 or WebM video.', launcherClearVideo: 'Clear video', launcherVideoPreview: 'Launcher video preview', launcherVideoPreviewError: 'The video could not be previewed.', launcherPlayVideo: 'Play video', launcherPauseVideo: 'Pause video', launcherMuteVideo: 'Mute video', launcherUnmuteVideo: 'Unmute video',
...
const zhTW = {
    translation: {
        ...
        saveServerOrder: '儲存排序', savingServerOrder: '正在儲存排序…', moveServerUp: '將 {{name}} 上移', moveServerDown: '將 {{name}} 下移', serverPosition: '第 {{position}} 順位', serverMoved: '已將 {{name}} 移至第 {{position}} 順位。',
        ...
        previousPage: '上一頁', nextPage: '下一頁', pageNumber: '第 {{page}} 頁', jobsPagination: '背景工作分頁', releasesPagination: '發布版本分頁',
        ...
        launcherPageHint: '設定此伺服器發布至 Helios 的圖片、品牌文字與更新來源。', launcherBackground: '主視覺背景', launcherLogo: '主視覺 Logo', launcherEyebrow: 'Launcher 頁首小標題', launcherTitle: '主標題', launcherTagline: '說明文字', launcherNewsRss: '伺服器更新 RSS 網址',
        launcherUsesDefault: '使用 Launcher 預設內容', launcherImageConfigured: '已選擇自訂圖片', launcherImageMissing: '來源圖片不存在，請重新上傳。', launcherClearImage: '清除圖片', launcherEmptyFallback: '欄位留空時沿用 Distribution 或 Launcher 的全域預設。', launcherImageTypeError: '請選擇 PNG、JPEG 或 WebP 圖片。', launcherFallbackEyebrow: 'MAPLECRAFT', launcherFallbackTagline: '伺服器內容會顯示在這裡。', launcherPreviewPlay: '開始遊戲', launcherPreviewMods: '模組', launcherPreviewUpdates: '更新說明',
        launcherVideo: '主視覺影片', launcherVideoNone: '不使用影片', launcherVideoUpload: '上傳 MP4／WebM', launcherVideoExternal: '外部 MP4／WebM 網址', launcherVideoYouTube: 'YouTube 影片', launcherVideoExternalUrl: '公開影片網址', launcherVideoYouTubeUrl: 'YouTube 網址', launcherVideoExternalHint: '發布時會驗證此 HTTPS 影片並複製到不可變的 Release。', launcherVideoYouTubeHint: '支援單一 watch、Shorts、youtu.be 或 embed 網址。', launcherVideoConfigured: '已設定影片', launcherVideoFileRequired: '請選擇 MP4 或 WebM 檔案。', launcherVideoUrlRequired: '請輸入影片網址。', launcherVideoTypeError: '請選擇 MP4 或 WebM 影片。', launcherClearVideo: '清除影片', launcherVideoPreview: 'Launcher 影片預覽', launcherVideoPreviewError: '無法預覽影片。', launcherPlayVideo: '播放影片', launcherPauseVideo: '暫停影片', launcherMuteVideo: '影片靜音', launcherUnmuteVideo: '取消影片靜音',
